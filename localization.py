...
STRINGS = {
    "en": {
        ...
        "save_folder": "SAVE FOLDER", "folder_placeholder": "not selected — files will be saved next to originals",
        ...
        "settings_delete_original": "Delete original file after conversion",
        ...
        "update_ver_label": "update v{old} → {new} available",
        ...
        "skipped_larger": "⊘ larger than original",
        "original_author": "Original author: cyber-anderson",
        "contrib_line": "UI update and added JPEG XL Support",
    ...
    "ru": {
        ...
        "save_folder": "ПАПКА ДЛЯ СОХРАНЕНИЯ", "folder_placeholder": "не выбрана — файлы сохранятся рядом с оригиналами",
        ...
        "settings_delete_original": "Удалять оригинал после конвертации",
        ...
        "update_ver_label": "доступно обновление v{old} → {new}",
        ...
        "skipped_larger": "⊘ больше оригинала",
        "original_author": "Автор оригинала: cyber-anderson",
        "contrib_line": "Обновление интерфейса и добавлена поддержка JPEG XL",
    ...
    "uk": {
        ...
        "save_folder": "ПАПКА ДЛЯ ЗБЕРЕЖЕННЯ", "folder_placeholder": "не обрана — файли буде збережено поруч з оригіналами",
        ...
        "settings_delete_original": "Видаляти оригінал після конвертації",
        ...
        "update_ver_label": "доступне оновлення v{old} → {new}",
        ...
        "skipped_larger": "⊘ більше за оригінал",
        "original_author": "Автор оригіналу: cyber-anderson",
        "contrib_line": "Оновлення інтерфейсу та додана підтримка JPEG XL",
    ...
    "de": {
        ...
        "save_folder": "SPEICHERORDNER", "folder_placeholder": "nicht ausgewählt — Dateien werden neben den Originalen gespeichert",
        ...
        "settings_delete_original": "Originaldatei nach der Konvertierung löschen",
        ...
        "update_ver_label": "Update v{old} → {new} verfügbar",
        ...
        "skipped_larger": "⊘ größer als das Original",
        "original_author": "Ursprünglicher Autor: cyber-anderson",
        "contrib_line": "UI-Update und JPEG-XL-Unterstützung hinzugefügt",
    ...
    "fi": {
        ...
        "save_folder": "TALLENNUSKANSIO", "folder_placeholder": "ei valittu — tiedostot tallennetaan alkuperäisten viereen",
        ...
        "settings_delete_original": "Poista alkuperäinen tiedosto muuntamisen jälkeen",
        ...
        "skipped_larger": "⊘ suurempi kuin alkuperäinen",
        "original_author": "Alkuperäinen tekijä: cyber-anderson",
        "contrib_line": "Käyttöliittymäpäivitys ja JPEG XL -tuki lisätty",
    ...
    "zh": {
        ...
        "save_folder": "保存文件夹", "folder_placeholder": "未选择 — 文件将保存到原文件所在文件夹",
        ...
        "skipped_larger": "⊘ 比原文件大",
        "original_author": "原作者：cyber-anderson",
        "contrib_line": "界面更新并添加 JPEG XL 支持",
